...
GitHub repository containing code and more information on how to reproduce the results of this report can be found following this link:
...
The chosen step sizes are $n_1 = 4000, n_2 = 8000, n_3 = 16000, n_4 = 32000$. For each step size the relative error of $\textbf{r}_i$
...
\begin{figure}[H]
    ...
    \caption{Here we see the vertical path of a single particle over 50 $\mu s$ for $N=5000$. The analytic, Euler and RK4 solutions are shown. We have for this motion $\omega_z^2 = 0.473$}
...
Figure \ref{fig:analytic_RK4_t_axis_2_N5000} and \ref{fig:analytic_RK4_axis_0_1_N5000} shows that the RK4 method agrees with the analytic solution even for a longer time period of 500 $\mu$s.
