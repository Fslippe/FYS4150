...
A detailed discussion of the algorithms' and results in presented in section \ref*{sec:discussion}, 
...
Expressing that the sum of forces equals mass times acceleration.
% ===========================================
