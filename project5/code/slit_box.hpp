...
public:
    ...
    // Consturctor
    SlitBox(double h_in, double dt_in, double T_in, double xc_in, double simgax_in, double px_in, double yx_in, double sigmay_in, double py_in, int v0_in);
    ...
    // initializes the potential V matrix for a given number of slits
    void init_V(int slits);

    // Evolve the system using dt to the chosen time T_in
